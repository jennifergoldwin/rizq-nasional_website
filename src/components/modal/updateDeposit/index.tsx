"use client";
import { Investment} from "@/utils/model";
import React from "react";
import { useForm, SubmitHandler, Controller } from "react-hook-form";

type Props = {
  showUpdateDepositModal: boolean;
  setShowUpdateDepositModal: any;
  handleUpdateDepositModal: any;
...
const UpdateDepositModal = (props: Props) => {
  const {
    handleSubmit,
    control,
    register,
  ...
  return (
    <div
      ...
      aria-hidden="true"
      className={`${
        props.showUpdateDepositModal ? "flex" : "hidden"
            ...
            <div className="grid gap-4 mb-4 grid-cols-2">
              ...
              <div className="col-span-2 sm:col-span-1">
                ...
                <input
                  ...
                  className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                  required
                  {...register("totalDeposit", { required: "Total deposit is required" })}
              ...
              <div className="col-span-2 sm:col-span-1">
                ...
                <input
                  ...
                  className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                  required
                  {...register("totalProfit", { required: "Date is required" })}
                />
              </div>
              <div className="col-span-2">
                <label
