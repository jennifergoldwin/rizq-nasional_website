...
const UserDetails: React.FC<UserDetailProps> = ({ user, totalDeposit = 0, totalInvestment = 0, totalProfit = 0}) => {
  return (
    <div className="mx-6 bg-[#01115E] px-8 py-6 rounded-xl my-6">
      <div className="flex items-center gap-4">
        <h1 className="font-bold text-xl">{user!=null?user.fullName:""}</h1>
        <div className="text-[#AF80F4] border-[1px] border-[#AF80F4] px-3 rounded-lg">
          Active
        </div>
      </div>
      <p className="text-white/[0.5] mb-4">{`ID: ${user!==null?user.identityNumber:""}`}</p>
